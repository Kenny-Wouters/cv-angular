  ...
  template: `
    <div class="relative isolate bg-gray-900">
      ...
      <div class="absolute inset-0 -z-10">
        <img src="assets/images/abstract-digital-grid-black-background.jpg" alt="Background" class="h-full w-full object-cover object-center">
          ...
          <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <dl class="mt-10 space-y-4 text-base/7 text-gray-300">
              ...
              <div class="flex gap-x-4">
                ...
                <dd><a class="hover:text-white" href="tel:+32 488 81 88 97">+32 488 81 88 97</a></dd>
              </div>
              <div class="flex gap-x-4">
                <dt class="flex-none">
                ...
                <dd><a class="hover:text-white" href="mailto:kendev007@outlook.com">kendev007&#64;outlook.com</a></dd>
              </div>
            </dl>
          </div>
        </div>
